...
## Приорітезація
Оновлення всередині вже приорітезуються, але цей процесс ще далекий від ідеалу, крім того, очікується більше контролю над цим процесом. Приорітети:

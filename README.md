...
## Проблеми
Якщо проміжок між оновленнями, більшу частину часу, менше ніж час оновлення, то оновлення може інколи не відбуватись. Це називається *голодування* `starvation`. Симулювати це можна збільшивши затримку при оновленні в демо.
